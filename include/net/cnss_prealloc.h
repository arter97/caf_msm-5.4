...
#define WCNSS_PRE_SKB_ALLOC_GET_THRESHOLD (32 * 1792)

extern struct sk_buff *wcnss_skb_prealloc_get(unsigned int);
extern int wcnss_skb_prealloc_put(struct sk_buff *);
