...
/** Enumeration for setting the data format to compressed data
...
/** ID for AFE port module. This will be used to define port properties.
  ...
  *  To configure the port property, the client must use the #AFE_PORT_CMD_SET_PARAM_V2 command,
...
/**
        ...
        -ID of the parameter used by #AFE_MODULE_PORT to set the port media type.
         This parameter ID is currently supported using the #AFE_PORT_CMD_SET_PARAM_V2 command.
*/
#define AFE_PARAM_ID_PORT_MEDIA_TYPE                            0x000102a7

/** Macros for defining the "data_format" field in the #AFE_PARAM_ID_PORT_MEDIA_TYPE */
#define AFE_PORT_DATA_FORMAT_PCM                                      0x0
#define AFE_PORT_DATA_FORMAT_GENERIC_COMPRESSED   0x1

/** Macro for defining the "minor_version" field in the #AFE_PARAM_ID_PORT_MEDIA_TYPE */
...
struct afe_port_media_type_t {
	...
	/**< Data format supported by this port.
	          If the port media type and device media type are different, it signifies a encoding/decoding use case.
...
struct afe_enc_cfg_blk_param_t {
	...
	*/
	union afe_enc_config        enc_blk_config;
};
