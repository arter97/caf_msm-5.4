...
#ifndef _DT_BINDINGS_CLK_QCOM_GCC_SDXPOORWILLS_H
#define _DT_BINDINGS_CLK_QCOM_GCC_SDXPOORWILLS_H
...
#define GCC_PCIE_PIPE_CLK_SRC					86
#define GCC_USB3_PHY_PIPE_CLK_SRC				87
