...
#include <dt-bindings/clock/apq-clocks-8084.h>
...
static struct clk_lookup apq_clocks_8084[] = {
	...
	CLK_DUMMY("iface_clk", lcc_core_smmu_cfg_clk.c, "fe064000.qcom,iommu",
									OFF),
	CLK_LOOKUP_OF("core_clk",  gcc_lpass_mport_axi_clk,
						"fe064000.qcom,iommu"),

	CLK_LOOKUP_OF("xo",  cxo_pil_lpass_clk,      "fe200000.qcom,lpass"),
	CLK_LOOKUP_OF("xo",  cxo_dwc3_clk,           "f9200000.ssusb"),
	CLK_LOOKUP_OF("xo",  cxo_lpm_clk,            "fc4281d0.qcom,mpm"),

	CLK_LOOKUP_OF("measure",	measure_clk,	"debug"),
	/* NFC */
	CLK_LOOKUP_OF("ref_clk",            bb_clk2_a_pin, "3-000e"),
	/* RPM clocks */
	...
	CLK_LOOKUP_OF("xo_clk", xo_clk_src, ""),
	CLK_LOOKUP_OF("hfpll_src", xo_a_clk_src, "f9016000.qcom,clock-krait"),
	CLK_LOOKUP_OF("bus_clk", mmssnoc_ahb_clk, ""),
	CLK_LOOKUP_OF("core_clk", gfx3d_clk_src, ""),
	CLK_LOOKUP_OF("core_clk", gfx3d_a_clk_src, ""),
	CLK_LOOKUP_OF("core_clk", qdss_clk, ""),
	CLK_LOOKUP("",	gcc_bimc_clk, ""),

	/* PLL */
	CLK_LOOKUP_OF("gpll0", gpll0_clk_src, ""),
	CLK_LOOKUP_OF("aux_clk", gpll0_ao_clk_src, "f9016000.qcom,clock-krait"),
	...
	CLK_LOOKUP_OF("bus_clk",	ocmemgx_msmbus_clk,  "msm-ocmem-vnoc"),
	CLK_LOOKUP_OF("bus_a_clk", ocmemgx_msmbus_a_clk, "msm-ocmem-vnoc"),
	CLK_LOOKUP_OF("ocmemvs_clk",	ocmemnoc_clk_src,	  "msm_bus"),
	CLK_LOOKUP_OF("ocmemvs_a_clk",	ocmemnoc_clk_src,	  "msm_bus"),
	...
	/* RCG source clocks */
	CLK_LOOKUP_OF("",	usb30_master_clk_src,	""),
	CLK_LOOKUP_OF("",	usb30_sec_master_clk_src,	""),
	CLK_LOOKUP_OF("",	usb_hsic_ahb_clk_src,	""),
	CLK_LOOKUP_OF("",	sata_asic0_clk_src,	""),
	CLK_LOOKUP_OF("",	sata_pmalive_clk_src,	""),
	CLK_LOOKUP_OF("",	sata_rx_clk_src,	""),
	CLK_LOOKUP_OF("",	sata_rx_oob_clk_src,	""),
	CLK_LOOKUP_OF("",	sdcc1_apps_clk_src,	""),
	CLK_LOOKUP_OF("",	sdcc2_apps_clk_src,	""),
	CLK_LOOKUP_OF("",	sdcc3_apps_clk_src,	""),
	CLK_LOOKUP_OF("",	sdcc4_apps_clk_src,	""),
	CLK_LOOKUP_OF("",	tsif_ref_clk_src,	""),
	CLK_LOOKUP_OF("",	usb30_mock_utmi_clk_src,	""),
	CLK_LOOKUP_OF("",	usb30_sec_mock_utmi_clk_src,	""),
	CLK_LOOKUP_OF("",	usb_hs_system_clk_src,	""),
	CLK_LOOKUP_OF("",	usb_hsic_clk_src,	""),
	CLK_LOOKUP_OF("",	usb_hsic_io_cal_clk_src,	""),
	CLK_LOOKUP_OF("",	usb_hsic_mock_utmi_clk_src,	""),
	CLK_LOOKUP_OF("",	usb_hsic_system_clk_src,	""),
	CLK_LOOKUP_OF("",	pcie_0_aux_clk_src,	""),
	CLK_LOOKUP_OF("",	pcie_0_pipe_clk_src,	""),
	CLK_LOOKUP_OF("",	pcie_1_aux_clk_src,	""),
	CLK_LOOKUP_OF("",	pcie_1_pipe_clk_src,	""),
	...
	CLK_LOOKUP_OF("",	gcc_blsp1_qup1_i2c_apps_clk,	""),
	CLK_LOOKUP_OF("core_clk",	gcc_blsp1_qup1_spi_apps_clk,
							"f9923000.spi"),
	CLK_LOOKUP_OF("",	gcc_blsp1_qup2_i2c_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp1_qup2_spi_apps_clk,	""),
	CLK_LOOKUP_OF("core_clk",	gcc_blsp1_qup3_i2c_apps_clk,
							"f9925000.i2c"),
	CLK_LOOKUP_OF("",	gcc_blsp1_qup3_spi_apps_clk,	""),
	/* NFC */
	CLK_LOOKUP_OF("core_clk",	gcc_blsp1_qup4_i2c_apps_clk,
							"f9926000.i2c"),
	CLK_LOOKUP_OF("",	gcc_blsp1_qup4_spi_apps_clk,	""),
	CLK_LOOKUP_OF("core_clk", gcc_blsp1_qup5_i2c_apps_clk, "f9927000.i2c"),
	CLK_LOOKUP_OF("",	gcc_blsp1_qup5_spi_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp1_qup6_i2c_apps_clk,	""),
	...
	CLK_LOOKUP_OF("",	gcc_blsp2_qup2_i2c_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp2_qup2_spi_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp2_qup3_i2c_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp2_qup3_spi_apps_clk,	""),
	CLK_LOOKUP_OF("core_clk", gcc_blsp2_qup4_i2c_apps_clk,	"f9966000.i2c"),
	CLK_LOOKUP_OF("",	gcc_blsp2_qup4_spi_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp2_qup5_i2c_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp2_qup5_spi_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_blsp2_qup6_i2c_apps_clk,	""),
	...
	CLK_LOOKUP_OF("core_clk",	gcc_blsp2_uart5_apps_clk,
							"f9961000.uart"),
	CLK_LOOKUP_OF("",	gcc_blsp2_uart6_apps_clk,	""),

	CLK_LOOKUP_OF("",	gcc_boot_rom_ahb_clk,	""),
	...
	CLK_LOOKUP_OF("scm_core_clk_src", scm_ce1_clk_src,
						"fe200000.qcom,lpass"),

	CLK_LOOKUP_OF("scm_core_clk", gcc_ce1_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("scm_iface_clk", gcc_ce1_ahb_clk,
						"fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("scm_bus_clk",  gcc_ce1_axi_clk,
						"fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("scm_core_clk_src", scm_ce1_clk_src,
						"fde0b000.qcom,pil-vpu"),
	...
	CLK_LOOKUP_OF("",	gcc_ce1_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_ce1_axi_clk,	""),
	CLK_LOOKUP_OF("",	ce1_clk_src,	""),
	CLK_LOOKUP_OF("",	gcc_ce1_clk,	""),
	CLK_LOOKUP_OF("",  branch_ce1_clk_src, ""),

	CLK_LOOKUP_OF("",	gcc_ce2_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_ce2_axi_clk,	""),
	CLK_LOOKUP_OF("",	ce2_clk_src,	""),
	CLK_LOOKUP_OF("",	gcc_ce2_clk,	""),
	CLK_LOOKUP_OF("",  branch_ce2_clk_src, ""),

	CLK_LOOKUP_OF("",	gcc_ce3_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_ce3_axi_clk,	""),
	CLK_LOOKUP_OF("",	ce3_clk_src,	""),
	CLK_LOOKUP_OF("",	gcc_ce3_clk,	""),

	CLK_LOOKUP_OF("",	gcc_copss_smmu_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_copss_smmu_axi_clk,	""),

	CLK_LOOKUP_OF("",	gcc_gp1_clk,	""),
	CLK_LOOKUP_OF("",	gcc_gp2_clk,	""),
	CLK_LOOKUP_OF("",	gcc_gp3_clk,	""),

	CLK_LOOKUP_OF("bus_clk",	gcc_lpass_q6_axi_clk,
						"fe200000.qcom,lpass"),
	...
	CLK_LOOKUP_OF("",	gcc_lpass_sway_clk,	""),

	CLK_LOOKUP_OF("",	gcc_pdm2_clk,	""),
	CLK_LOOKUP_OF("",	gcc_pdm_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_periph_noc_usb_hsic_ahb_clk,	""),
	CLK_LOOKUP_OF("iface_clk", gcc_prng_ahb_clk, "f9bff000.qcom,msm-rng"),
	...
	CLK_LOOKUP_OF("core_clk_src", qseecom_ce1_clk_src, "qseecom"),
	...
	CLK_LOOKUP_OF("ce_drv_core_clk_src", qseecom_ce2_clk_src, "qseecom"),
	...
	CLK_LOOKUP_OF("core_clk_src", mcd_ce1_clk_src, "mcd"),

	/* CRYPTO driver clocks */
	CLK_LOOKUP_OF("core_clk",     gcc_ce2_clk,     "fd440000.qcom,qcedev"),
	CLK_LOOKUP_OF("iface_clk",    gcc_ce2_ahb_clk, "fd440000.qcom,qcedev"),
	CLK_LOOKUP_OF("bus_clk",      gcc_ce2_axi_clk, "fd440000.qcom,qcedev"),
	CLK_LOOKUP_OF("core_clk_src", qcedev_ce2_clk_src,
	...
	CLK_LOOKUP_OF("core_clk_src", qcrypto_ce2_clk_src,
						"fd440000.qcom,qcrypto"),

	/* SATA clocks */
	CLK_LOOKUP_OF("core_clk", gcc_sata_axi_clk,          "fc580000.sata"),
	CLK_LOOKUP_OF("iface_clk", gcc_sata_cfg_ahb_clk,     "fc580000.sata"),
	CLK_LOOKUP_OF("rxoob_clk", gcc_sata_rx_oob_clk,      "fc580000.sata"),
	CLK_LOOKUP_OF("pmalive_clk", gcc_sata_pmalive_clk,   "fc580000.sata"),
	CLK_LOOKUP_OF("asic0_clk", gcc_sata_asic0_clk,       "fc580000.sata"),
	CLK_LOOKUP_OF("rbc0_clk", gcc_sata_rx_clk,           "fc580000.sata"),
	CLK_LOOKUP_OF("ref_clk_src", rf_clk3,             "fc581000.sataphy"),
	CLK_LOOKUP_OF("ref_clk_parent", pcie_1_phy_ldo,   "fc581000.sataphy"),
	CLK_LOOKUP_OF("ref_clk", sata_phy_ldo,            "fc581000.sataphy"),
	CLK_LOOKUP_OF("rxoob_clk", gcc_sata_rx_oob_clk,   "fc581000.sataphy"),

	/* SDCC clocks */
	CLK_LOOKUP_OF("iface_clk",	gcc_sdcc1_ahb_clk,   "f9824900.sdhci"),
	CLK_LOOKUP_OF("core_clk",	gcc_sdcc1_apps_clk, "f9824900.sdhci"),
	CLK_LOOKUP_OF("cal_clk",	gcc_sdcc1_cdccal_ff_clk,
							"f9824900.sdhci"),
	CLK_LOOKUP_OF("sleep_clk",	gcc_sdcc1_cdccal_sleep_clk,
							"f9824900.sdhci"),
	CLK_LOOKUP_OF("iface_clk",	gcc_sdcc2_ahb_clk,  "f98a4900.sdhci"),
	CLK_LOOKUP_OF("core_clk",	gcc_sdcc2_apps_clk, "f98a4900.sdhci"),
	CLK_LOOKUP_OF("",	gcc_sdcc3_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_sdcc3_apps_clk,	""),
	CLK_LOOKUP_OF("",	gcc_sdcc4_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_sdcc4_apps_clk,	""),

	CLK_LOOKUP_OF("",	gcc_spss_ahb_clk,	""),
	CLK_LOOKUP_OF("mem_iface_clk",	gcc_sys_noc_usb3_axi_clk,
						"f9304000.qcom,usbbam"),

	CLK_LOOKUP_OF("",	gcc_tsif_ahb_clk,	""),
	CLK_LOOKUP_OF("",	gcc_tsif_ref_clk,	""),
	CLK_LOOKUP_OF("iface_clk", gcc_tsif_ahb_clk, "f99d8000.msm_tspp"),
	CLK_LOOKUP_OF("ref_clk", gcc_tsif_ref_clk, "f99d8000.msm_tspp"),

	/* UFS clocks */
	CLK_LOOKUP_OF("ref_clk", rf_clk1,                 "fc594000.ufshc"),
	CLK_LOOKUP_OF("bus_clk", gcc_sys_noc_ufs_axi_clk, "fc594000.ufshc"),
	CLK_LOOKUP_OF("iface_clk", gcc_ufs_ahb_clk,       "fc594000.ufshc"),
	CLK_LOOKUP_OF("core_clk", gcc_ufs_axi_clk,        "fc594000.ufshc"),
	CLK_LOOKUP_OF("core_clk_src", ufs_axi_clk_src, "fc594000.ufshc"),
	CLK_LOOKUP_OF("iface_clk", gcc_sys_noc_ufs_axi_clk,  "msm_bus_ufs"),
	CLK_LOOKUP_OF("rx_lane0_sync_clk", gcc_ufs_rx_symbol_0_clk,
							"fc594000.ufshc"),
	CLK_LOOKUP_OF("rx_lane1_sync_clk", gcc_ufs_rx_symbol_1_clk,
							"fc594000.ufshc"),
	CLK_LOOKUP_OF("tx_lane0_sync_clk", gcc_ufs_tx_symbol_0_clk,
							"fc594000.ufshc"),
	CLK_LOOKUP_OF("tx_lane1_sync_clk", gcc_ufs_tx_symbol_1_clk,
							"fc594000.ufshc"),
	/* UFS PHY clocks */
	CLK_LOOKUP_OF("ref_clk_src", rf_clk3,             "fc597000.ufsphy"),
	CLK_LOOKUP_OF("ref_clk_parent", pcie_1_phy_ldo,   "fc597000.ufsphy"),
	CLK_LOOKUP_OF("ref_clk", sata_phy_ldo,            "fc597000.ufsphy"),
	CLK_LOOKUP_OF("tx_iface_clk", gcc_ufs_tx_cfg_clk, "fc597000.ufsphy"),
	CLK_LOOKUP_OF("rx_iface_clk", gcc_ufs_rx_cfg_clk, "fc597000.ufsphy"),

	/* USB clocks */
	CLK_LOOKUP_OF("ref_clk", diff_clk1, "f9200000.ssusb"),
	CLK_LOOKUP_OF("xo", cxo_dwc3_clk, "f9200000.ssusb"),
	CLK_LOOKUP_OF("core_clk", gcc_usb30_master_clk, "f92f8800.hsphy"),
	CLK_LOOKUP_OF("core_clk", gcc_usb30_master_clk, "f92f8800.ssphy"),
	CLK_LOOKUP_OF("core_clk", gcc_usb30_master_clk, "f9200000.ssusb"),
	CLK_LOOKUP_OF("iface_clk", gcc_sys_noc_usb3_axi_clk, "f9200000.ssusb"),
	CLK_LOOKUP_OF("iface_clk", gcc_sys_noc_usb3_axi_clk, "msm_usb3"),
	CLK_LOOKUP_OF("iface_clk", gcc_sys_noc_usb3_sec_axi_clk, "msm_usb3_1"),
	CLK_LOOKUP_OF("sleep_clk", gcc_usb30_sleep_clk, "f9200000.ssusb"),
	CLK_LOOKUP_OF("utmi_clk",   gcc_usb30_mock_utmi_clk, "f9200000.ssusb"),
	CLK_LOOKUP_OF("phy_sleep_clk", gcc_usb2a_phy_sleep_clk,
			"f92f8800.hsphy"),
	CLK_LOOKUP_OF("com_reset_clk", gcc_usb30_phy_com_clk, "f92f8800.ssphy"),
	CLK_LOOKUP_OF("reset_clk",	gcc_usb3_phy_clk, "f92f8800.ssphy"),

	CLK_LOOKUP_OF("ref_clk", diff_clk1, "f9400000.ssusb"),
	CLK_LOOKUP_OF("xo", cxo_dwc3_clk, "f9400000.ssusb"),
	CLK_LOOKUP_OF("core_clk", gcc_usb30_sec_master_clk, "f94f8800.hsphy"),
	CLK_LOOKUP_OF("core_clk", gcc_usb30_sec_master_clk, "f94f8800.ssphy"),
	CLK_LOOKUP_OF("core_clk", gcc_usb30_sec_master_clk, "f9400000.ssusb"),
	CLK_LOOKUP_OF("iface_clk", gcc_sys_noc_usb3_sec_axi_clk,
			"f9400000.ssusb"),
	CLK_LOOKUP_OF("sleep_clk", gcc_usb30_sec_sleep_clk, "f9400000.ssusb"),
	CLK_LOOKUP_OF("utmi_clk",  gcc_usb30_sec_mock_utmi_clk,
			"f9400000.ssusb"),
	CLK_LOOKUP_OF("phy_sleep_clk", gcc_usb2a_phy_sleep_clk,
			"f94f8800.hsphy"),

	CLK_LOOKUP_OF("",	gcc_usb2b_phy_sleep_clk,	""),
	CLK_LOOKUP_OF("mem_clk",	gcc_usb30_master_clk,
							"f9304000.qcom,usbbam"),

	CLK_LOOKUP_OF("xo",	cxo_otg_clk,			"f9a55000.usb"),
	CLK_LOOKUP_OF("iface_clk",	gcc_usb_hs_ahb_clk,	"f9a55000.usb"),
	CLK_LOOKUP_OF("core_clk",	gcc_usb_hs_system_clk,	"f9a55000.usb"),
	CLK_LOOKUP_OF("sleep_clk", gcc_usb2a_phy_sleep_clk,	"f9a55000.usb"),

	CLK_LOOKUP_OF("core_clk", gcc_usb_hsic_ahb_clk, "msm_hsic_host"),
	CLK_LOOKUP_OF("hsic_clk", gcc_usb_hsic_clk, "msm_hsic_host"),
	CLK_LOOKUP_OF("cal_clk", gcc_usb_hsic_io_cal_clk, "msm_hsic_host"),
	CLK_LOOKUP_OF("phy_sleep_clk", gcc_usb_hsic_io_cal_sleep_clk,
			"msm_hsic_host"),
	CLK_LOOKUP_OF("utmi_clk", gcc_usb_hsic_mock_utmi_clk, "msm_hsic_host"),
	CLK_LOOKUP_OF("system_clk", gcc_usb_hsic_system_clk, "msm_hsic_host"),

	/* PCIE clocks */
	CLK_LOOKUP_OF("pcie_0_aux_clk", gcc_pcie_0_aux_clk, "msm_pcie.1"),
	CLK_LOOKUP_OF("pcie_0_cfg_ahb_clk", gcc_pcie_0_cfg_ahb_clk,
			"msm_pcie.1"),
	CLK_LOOKUP_OF("pcie_0_mstr_axi_clk", gcc_pcie_0_mstr_axi_clk,
			"msm_pcie.1"),
	CLK_LOOKUP_OF("pcie_0_pipe_clk", gcc_pcie_0_pipe_clk, "msm_pcie.1"),
	CLK_LOOKUP_OF("pcie_0_slv_axi_clk", gcc_pcie_0_slv_axi_clk,
			"msm_pcie.1"),
	CLK_LOOKUP_OF("pcie_0_ref_clk_src", rf_clk3, "msm_pcie.1"),
	CLK_LOOKUP_OF("pcie_1_aux_clk", gcc_pcie_1_aux_clk, "msm_pcie.2"),
	CLK_LOOKUP_OF("pcie_1_cfg_ahb_clk", gcc_pcie_1_cfg_ahb_clk,
			"msm_pcie.2"),
	CLK_LOOKUP_OF("pcie_1_mstr_axi_clk", gcc_pcie_1_mstr_axi_clk,
			"msm_pcie.2"),
	CLK_LOOKUP_OF("pcie_1_pipe_clk", gcc_pcie_1_pipe_clk, "msm_pcie.2"),
	CLK_LOOKUP_OF("pcie_1_slv_axi_clk", gcc_pcie_1_slv_axi_clk,
			"msm_pcie.2"),
	CLK_LOOKUP_OF("pcie_1_ref_clk_src", rf_clk3, "msm_pcie.2"),

	/* CoreSight clocks */
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc326000.tmc"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc320000.tpiu"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc324000.replicator"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc325000.tmc"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc323000.funnel"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc321000.funnel"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc322000.funnel"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc345000.funnel"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc355000.funnel"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc36c000.funnel"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc302000.stm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc34c000.etm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc34d000.etm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc34e000.etm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc34f000.etm"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc310000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc311000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc312000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc313000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc314000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc315000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc316000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc317000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc318000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc350000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc351000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc352000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc353000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc354000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc330000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc33c000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc360000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fc36b000.cti"),
	CLK_LOOKUP_OF("core_clk", qdss_clk, "fd828018.hwevent"),

	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc326000.tmc"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc320000.tpiu"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc324000.replicator"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc325000.tmc"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc323000.funnel"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc321000.funnel"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc322000.funnel"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc345000.funnel"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc355000.funnel"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc36c000.funnel"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc302000.stm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc34c000.etm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc34d000.etm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc34e000.etm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc34f000.etm"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc310000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc311000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc312000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc313000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc314000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc315000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc316000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc317000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc318000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc350000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc351000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc352000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc353000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc354000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc330000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc33c000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc360000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fc36b000.cti"),
	CLK_LOOKUP_OF("core_a_clk", qdss_a_clk, "fd828018.hwevent"),

	CLK_LOOKUP_OF("osr_clk", div_clk1, "msm-dai-q6-dev.16384"),
	CLK_LOOKUP_OF("core_mmss_clk", mmss_misc_ahb_clk, "fd828018.hwevent"),
	CLK_LOOKUP_OF("pwm_clk", div_clk2, "2-0048"),

	/* Multimedia clocks */
	CLK_LOOKUP_OF("",	axi_clk_src,	""),
	CLK_LOOKUP_OF("",	vcodec0_clk_src,	""),
	CLK_LOOKUP_OF("",	mdp_clk_src,	""),
	CLK_LOOKUP_OF("",	ocmemnoc_clk_src,	""),
	CLK_LOOKUP_OF("",	gfx3d_clk_src,	""),
	CLK_LOOKUP_OF("",	vp_clk_src,	""),
	CLK_LOOKUP_OF("",	gp0_clk_src,	""),
	CLK_LOOKUP_OF("",	gp1_clk_src,	""),
	CLK_LOOKUP_OF("",	edpaux_clk_src,	""),
	CLK_LOOKUP_OF("",	esc0_clk_src,	""),
	CLK_LOOKUP_OF("",	esc1_clk_src,	""),
	CLK_LOOKUP_OF("",	hdmi_clk_src,	""),
	CLK_LOOKUP_OF("",	vsync_clk_src,	""),
	CLK_LOOKUP_OF("",	maple_clk_src,	""),
	CLK_LOOKUP_OF("",	vdp_clk_src,	""),
	CLK_LOOKUP_OF("",	vpu_bus_clk_src,	""),
	CLK_LOOKUP_OF("",	avsync_ahb_clk,	""),
	CLK_LOOKUP_OF("",	avsync_vp_clk,	""),

	/* Camera Clocks */
	/* CCI clocks */
	CLK_LOOKUP_OF("camss_top_ahb_clk", camss_top_ahb_clk,
			"fda0c000.qcom,cci"),
	CLK_LOOKUP_OF("camss_ahb_clk", camss_ahb_clk, "fda0c000.qcom,cci"),
	...
	CLK_LOOKUP_OF("camss_ahb_clk", camss_ahb_clk,
						"fda0ac00.qcom,csiphy"),
	...
	CLK_LOOKUP_OF("camss_ahb_clk", camss_ahb_clk,
					"fda10000.qcom,vfe"),
	CLK_LOOKUP_OF("vfe_clk_src", vfe0_clk_src,
					"fda10000.qcom,vfe"),
	...
	CLK_LOOKUP_OF("iface_clk", camss_vfe_vfe_ahb_clk,
					"fda10000.qcom,vfe"),
	CLK_LOOKUP_OF("bus_clk", camss_vfe_vfe_axi_clk,
					"fda10000.qcom,vfe"),
	/* VFE 1 */
	CLK_LOOKUP_OF("camss_top_ahb_clk", camss_top_ahb_clk,
					"fda14000.qcom,vfe"),
	CLK_LOOKUP_OF("camss_ahb_clk", camss_ahb_clk,
					"fda14000.qcom,vfe"),
	CLK_LOOKUP_OF("vfe_clk_src", vfe1_clk_src,
					"fda14000.qcom,vfe"),
	...
	CLK_LOOKUP_OF("cpp_iface_clk", camss_vfe_cpp_ahb_clk,
						"fda04000.qcom,cpp"),
	CLK_LOOKUP_OF("cpp_core_clk", camss_vfe_cpp_clk,
						"fda04000.qcom,cpp"),
	...
	CLK_LOOKUP_OF("iface_clk", mdss_ahb_clk, "fd900000.qcom,mdss_mdp"),
	CLK_LOOKUP_OF("bus_clk", mdss_axi_clk, "fd900000.qcom,mdss_mdp"),
	CLK_LOOKUP_OF("core_clk_src", mdp_clk_src, "fd900000.qcom,mdss_mdp"),
	...
	CLK_LOOKUP_OF("core_mmss_clk", mmss_misc_ahb_clk,
		"fd922800.qcom,mdss_dsi"),
	CLK_LOOKUP_OF("core_mmss_clk", mmss_misc_ahb_clk,
		"fd922e00.qcom,mdss_dsi"),
	CLK_LOOKUP_OF("core_clk", mdss_mdp_clk, "fd900000.qcom,mdss_mdp"),
	CLK_LOOKUP_OF("lut_clk", mdss_mdp_lut_clk, "fd900000.qcom,mdss_mdp"),
	CLK_LOOKUP_OF("vsync_clk", mdss_vsync_clk, "fd900000.qcom,mdss_mdp"),
	CLK_LOOKUP_OF("",	avsync_extpclk_clk,	""),
	CLK_LOOKUP_OF("",	mdss_axi_clk,	""),
	CLK_LOOKUP_OF("",	mdss_esc0_clk,	""),
	CLK_LOOKUP_OF("",	mdss_esc1_clk,	""),
	...
	CLK_LOOKUP_OF("",	mdss_mdp_clk,	""),
	CLK_LOOKUP_OF("",	mdss_mdp_lut_clk,	""),
	CLK_LOOKUP_OF("",	mdss_vsync_clk,	""),
	...
	CLK_LOOKUP_OF("avsync_pixel_clk", mdss_avsync_edppixel_clk,
	...
	CLK_LOOKUP_OF("",	hdmipll_clk_src,	""),
	CLK_LOOKUP_OF("",	hdmipll_mux_clk,	""),
	CLK_LOOKUP_OF("",	hdmipll_div1_clk,	""),
	CLK_LOOKUP_OF("",	hdmipll_div2_clk,	""),
	CLK_LOOKUP_OF("",	hdmipll_div4_clk,	""),
	CLK_LOOKUP_OF("",	hdmipll_div6_clk,	""),

	CLK_LOOKUP_OF("",	mmss_misc_ahb_clk,	""),
	CLK_LOOKUP_OF("",	mmss_mmssnoc_axi_clk,	""),
	CLK_LOOKUP_OF("",	mmss_s0_axi_clk,	""),

	CLK_LOOKUP_OF("core_clk",  ocmemgx_core_clk, "fdd00000.qcom,ocmem"),
	CLK_LOOKUP_OF("iface_clk",	ocmemcx_ocmemnoc_clk,
						"fdd00000.qcom,ocmem"),
	CLK_LOOKUP_OF("core_clk",	oxili_gfx3d_clk,
						"fdb00000.qcom,kgsl-3d0"),
	CLK_LOOKUP_OF("iface_clk",	oxilicx_ahb_clk,
						"fdb00000.qcom,kgsl-3d0"),
	CLK_LOOKUP_OF("rbbmtimer_clk", oxili_rbbmtimer_clk,
						"fdb00000.qcom,kgsl-3d0"),

	CLK_LOOKUP_OF("",	venus0_ahb_clk,	""),
	CLK_LOOKUP_OF("",	venus0_axi_clk,	""),
	CLK_LOOKUP_OF("",	venus0_core0_vcodec_clk,	""),
	CLK_LOOKUP_OF("",	venus0_core1_vcodec_clk,	""),
	CLK_LOOKUP_OF("",	venus0_ocmemnoc_clk,	""),
	CLK_LOOKUP_OF("",	venus0_vcodec0_clk,	""),
	CLK_LOOKUP_OF("iface_clk",	venus0_ahb_clk, "fdce0000.qcom,venus"),
	CLK_LOOKUP_OF("bus_clk",	venus0_axi_clk, "fdce0000.qcom,venus"),
	CLK_LOOKUP_OF("mem_clk",	venus0_ocmemnoc_clk,
						 "fdce0000.qcom,venus"),
	CLK_LOOKUP_OF("core_clk",	venus0_vcodec0_clk,
						 "fdce0000.qcom,venus"),
	...
	CLK_LOOKUP_OF("core_clk",	venus0_vcodec0_clk,
						 "fdc00000.qcom,vidc"),
	CLK_LOOKUP_OF("core0_clk",	venus0_core0_vcodec_clk,
						 "fdc00000.qcom,vidc"),
	CLK_LOOKUP_OF("core1_clk",	venus0_core1_vcodec_clk,
						 "fdc00000.qcom,vidc"),

	CLK_LOOKUP_OF("iface_clk", vpu_ahb_clk, "fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("bus_clk", vpu_axi_clk, "fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("vdp_clk", vpu_vdp_clk, "fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("vdp_bus_clk", vpu_bus_clk, "fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("cxo_clk", vpu_cxo_clk, "fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("core_clk", vpu_maple_clk, "fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("sleep_clk", vpu_sleep_clk, "fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("maple_bus_clk", gcc_mmss_vpu_maple_sys_noc_axi_clk,
						"fde0b000.qcom,vpu"),
	CLK_LOOKUP_OF("prng_clk", gcc_prng_ahb_clk, "fde0b000.qcom,vpu"),

	CLK_LOOKUP_OF("iface_clk", vpu_ahb_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("bus_clk", vpu_axi_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("vdp_clk", vpu_vdp_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("vdp_bus_clk", vpu_bus_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("cxo_clk", vpu_cxo_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("core_clk", vpu_maple_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("sleep_clk", vpu_sleep_clk, "fde0b000.qcom,pil-vpu"),
	CLK_LOOKUP_OF("maple_bus_clk", gcc_mmss_vpu_maple_sys_noc_axi_clk,
						"fde0b000.qcom,pil-vpu"),

	CLK_LOOKUP_OF("",	vpu_ahb_clk,	""),
	CLK_LOOKUP_OF("",	vpu_axi_clk,	""),
	CLK_LOOKUP_OF("",	vpu_bus_clk,	""),
	CLK_LOOKUP_OF("",	vpu_cxo_clk,	""),
	CLK_LOOKUP_OF("",	vpu_maple_clk,	""),
	CLK_LOOKUP_OF("",	vpu_sleep_clk,	""),
	CLK_LOOKUP_OF("",	vpu_vdp_clk,	""),
	...
	CLK_LOOKUP_OF("core_clk", camss_jpeg_jpeg_axi_clk,
						"fda64000.qcom,iommu"),
	CLK_LOOKUP_OF("alt_core_clk", camss_top_ahb_clk,
						"fda64000.qcom,iommu"),
	CLK_LOOKUP_OF("alt_iface_clk", camss_ahb_clk,
						"fda64000.qcom,iommu"),
	CLK_LOOKUP_OF("iface_clk", camss_vfe_vfe_ahb_clk,
						"fda44000.qcom,iommu"),
	CLK_LOOKUP_OF("core_clk", camss_vfe_vfe_axi_clk,
						"fda44000.qcom,iommu"),
	CLK_LOOKUP_OF("alt_core_clk", camss_top_ahb_clk,
						"fda44000.qcom,iommu"),
	CLK_LOOKUP_OF("alt_iface_clk", camss_ahb_clk,
	...
	CLK_LOOKUP_OF("core_clk", oxili_gfx3d_clk, "fdb10000.qcom,iommu"),
	...
	CLK_LOOKUP_OF("iface_clk", gcc_copss_smmu_ahb_clk,
						"f9bc4000.qcom,iommu"),
	CLK_LOOKUP_OF("core_clk", gcc_copss_smmu_axi_clk,
						"f9bc4000.qcom,iommu"),
	CLK_LOOKUP_OF("iface_clk", vpu_ahb_clk, "fdee4000.qcom,iommu"),
	CLK_LOOKUP_OF("core_clk", vpu_axi_clk, "fdee4000.qcom,iommu"),
	CLK_LOOKUP_OF("alt_core_clk", vpu_bus_clk, "fdee4000.qcom,iommu"),
	CLK_LOOKUP_OF("core_clk", gcc_lpass_q6_axi_clk,
						"fe054000.qcom,iommu"),
	CLK_LOOKUP_OF("core_clk", vpu_vdp_clk, "fd8c1404.qcom,gdsc"),
	CLK_LOOKUP_OF("maple_clk", vpu_maple_clk, "fd8c1404.qcom,gdsc"),
	...
	/* DSI PLL clocks */
	CLK_LOOKUP_OF("",		dsi_vco_clk_8084,                  ""),
	CLK_LOOKUP_OF("",		analog_postdiv_clk_8084,         ""),
	CLK_LOOKUP_OF("",		indirect_path_div2_clk_8084,     ""),
	CLK_LOOKUP_OF("",		pixel_clk_src_8084,              ""),
	CLK_LOOKUP_OF("",		byte_mux_8084,                   ""),
	CLK_LOOKUP_OF("",		byte_clk_src_8084,               ""),

	/* LDO */
	CLK_LOOKUP_OF("pcie_0_ldo",	pcie_0_phy_ldo,  "msm_pcie.1"),
	CLK_LOOKUP_OF("pcie_1_ldo",	pcie_1_phy_ldo,  "msm_pcie.2"),
	CLK_LOOKUP_OF("",		sata_phy_ldo,               ""),

	/* QCA1530 clocks */
	CLK_LOOKUP_OF("qca,rtc_clk",	div_clk3, "qca1530.1"),
	CLK_LOOKUP_OF("qca,tcxo_clk",	rf_clk2_pin, "qca1530.1"),
};
...
static int gcc_probe(struct platform_device *pdev)
{
	...
	rc =  of_msm_clock_register(dev->of_node,
			apq_clocks_8084, ARRAY_SIZE(apq_clocks_8084));
	if (rc)
		return rc;
