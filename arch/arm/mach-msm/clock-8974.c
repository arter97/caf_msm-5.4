...
static struct clk_lookup msm_clocks_8974pro_only[] __initdata = {
	...
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "24.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "6d.qcom,eeprom"),
	...
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "24.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "6d.qcom,eeprom"),
...
static struct clk_lookup msm_clocks_8974_only[] __initdata = {
	...
	CLK_LOOKUP("cam_src_clk", gp1_clk_src.c, "24.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", gp1_clk_src.c, "6d.qcom,eeprom"),
	...
	CLK_LOOKUP("cam_clk", gcc_gp1_clk.c, "24.qcom,camera"),
	CLK_LOOKUP("cam_clk", gcc_gp1_clk.c, "6d.qcom,eeprom"),
