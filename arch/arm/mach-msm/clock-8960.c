...
static struct clk_freq_tbl clk_tbl_tv[] = {
	...
	F_TV( 37100000, hdmi_pll,  37100000, 1, 0, 0),
	F_TV( 71107000, hdmi_pll,  71107000, 1, 0, 0),
...
static struct clk_lookup msm_clocks_8064[] = {
...
#endif
#ifdef CONFIG_MACH_APQ8064_ADP2_ES2
...
#endif
#ifndef CONFIG_MACH_APQ8064_ADP2_ES2
#ifndef CONFIG_MACH_LGE
	...
	CLK_LOOKUP("alt_core_clk",	usb_hs1_xcvr_clk.c,	"msm_otg.1"),
	CLK_LOOKUP("alt_core_clk",	usb_hs3_xcvr_clk.c,	"msm_otg.3"),
	CLK_LOOKUP("alt_core_clk",	usb_hs4_xcvr_clk.c,	"msm_otg.4"),
	...
	CLK_LOOKUP("iface_clk",		usb_hs1_p_clk.c,	"msm_otg.1"),
	CLK_LOOKUP("iface_clk",		usb_hs3_p_clk.c,	"msm_otg.3"),
	CLK_LOOKUP("iface_clk",		usb_hs4_p_clk.c,	"msm_otg.4"),
	...
	CLK_LOOKUP("osr_clk",		mi2s_osr_clk.c,
			    "msm-dai-q6-mi2s"),
	CLK_LOOKUP("bit_clk",		mi2s_bit_clk.c,
			    "msm-dai-q6-mi2s-group.6"),
	CLK_LOOKUP("osr_clk",		mi2s_osr_clk.c,
			    "msm-dai-q6-mi2s-group.6"),
	CLK_LOOKUP("bit_clk",		mi2s_bit_clk.c,
			    "msm-dai-q6-mi2s-group.14"),
	CLK_LOOKUP("osr_clk",		mi2s_osr_clk.c,
			    "msm-dai-q6-mi2s-group.14"),
	CLK_LOOKUP("bit_clk",		mi2s_bit_clk.c,
			    "msm-dai-q6-mi2s-group.16"),
	CLK_LOOKUP("osr_clk",		mi2s_osr_clk.c,
			    "msm-dai-q6-mi2s-group.16"),
	CLK_LOOKUP("bit_clk",		mi2s_bit_clk.c,
	...
	CLK_LOOKUP("osr_clk",		codec_i2s_mic_osr_clk.c,
			   "msm-dai-q6.1"),
	CLK_LOOKUP("bit_clk",		codec_i2s_mic_bit_clk.c,
			   "msm-dai-q6-mi2s-group.1"),
	CLK_LOOKUP("osr_clk",		codec_i2s_mic_osr_clk.c,
			   "msm-dai-q6-mi2s-group.1"),
	CLK_LOOKUP("bit_clk",		codec_i2s_mic_bit_clk.c,
			   "msm-dai-q6-mi2s-group.29"),
	CLK_LOOKUP("osr_clk",		codec_i2s_mic_osr_clk.c,
			   "msm-dai-q6-mi2s-group.29"),
	...
	CLK_LOOKUP("core_clk",		dfab_usb_hs_clk.c,	"msm_otg.1"),
	CLK_LOOKUP("core_clk",		dfab_usb_hs3_clk.c,	"msm_otg.3"),
	CLK_LOOKUP("core_clk",		dfab_usb_hs3_clk.c,	"msm_otg.4"),
...
static struct clk_lookup msm_clocks_8064_mplatform[] = {
	CLK_LOOKUP("xo",		cxo_a_clk.c,	""),
	CLK_LOOKUP("xo",		pxo_a_clk.c,	""),
	CLK_LOOKUP("pwm_clk",		cxo_clk.c,	"0-0048"),
	CLK_LOOKUP("cxo",		cxo_clk.c,	"wcnss_wlan.0"),
	...
	CLK_LOOKUP("core_clk",		gsbi3_uart_clk.c,   "msm_serial_hsl.3"),
#ifdef CONFIG_MACH_LGE
	CLK_LOOKUP("core_clk",		gsbi4_uart_clk.c,   "msm_serial_hsl.0"),
#else
	CLK_LOOKUP("core_clk",		gsbi4_uart_clk.c, "msm_serial_hs.1"),
	...
	CLK_LOOKUP("iface_clk",		gsbi3_p_clk.c,	"msm_serial_hsl.3"),
#ifdef CONFIG_MACH_LGE
	CLK_LOOKUP("iface_clk",		gsbi4_p_clk.c,	"msm_serial_hsl.0"),
#endif
	CLK_LOOKUP("iface_clk",		gsbi4_p_clk.c,		"qup_i2c.4"),
...
static struct clk_lookup msm_clocks_8960_common[] __initdata = {
	...
	CLK_LOOKUP("core_clk",		tssc_clk.c,		""),
	CLK_LOOKUP("alt_core_clk",	usb_hs1_xcvr_clk.c,	"msm_otg.1"),
	CLK_LOOKUP("phy_clk",		usb_phy0_clk.c,		"msm_otg.1"),
	CLK_LOOKUP("alt_core_clk",	usb_fs1_xcvr_clk.c,	""),
	CLK_LOOKUP("sys_clk",		usb_fs1_sys_clk.c,	""),
	CLK_LOOKUP("src_clk",		usb_fs1_src_clk.c,	""),
...
struct clock_init_data apq8064_mplatform_clock_init_data __initdata = {
	.table = msm_clocks_8064_mplatform,
	.size = ARRAY_SIZE(msm_clocks_8064_mplatform),
	.pre_init = msm8960_clock_pre_init,
	.post_init = msm8960_clock_post_init,
	.late_init = msm8960_clock_late_init,
};
