...
static int __devinit parse_smdpkt_devicetree(struct device_node *node,
					struct smd_pkt_dev *smd_pkt_devp)
{
	int edge;
	char *key;
...
static int __devinit smd_pkt_devicetree_init(struct platform_device *pdev)
{
	int ret;
	int i = 0;
...
static int __devinit msm_smd_pkt_probe(struct platform_device *pdev)
{
	int ret;
	/*
