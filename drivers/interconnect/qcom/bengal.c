...
static struct qcom_icc_qosbox xm_ufs_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x2e000, },
	.config = &(struct qos_config) {
...
static struct qcom_icc_node xm_ufs = {
	.name = "xm_ufs",
	.id = MASTER_UFS_MEM,
	.channels = 1,
	.buswidth = 8,
...
static struct qcom_icc_node qhs_ufs = {
	.name = "qhs_ufs",
...
static struct qcom_icc_desc bengal_bimc = {
	.nodes = bimc_nodes,
...
static struct qcom_icc_desc bengal_config_noc = {
...
static struct qcom_icc_desc bengal_mmnrt_virt = {
...
static struct qcom_icc_desc bengal_mmrt_virt = {
...
static struct qcom_icc_desc bengal_sys_noc = {
	.nodes = sys_noc_nodes,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	dev_info(dev, "Registered Bengal ICC\n");
...
static void qnoc_sync_state(struct device *dev)
{
	...
	pr_err("Bengal ICC Sync State done\n");
}
...
MODULE_DESCRIPTION("Bengal NoC driver");
