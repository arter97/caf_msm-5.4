...
static struct qcom_icc_bcm bcm_pn0 = {
	...
	.keepalive = true,
	.num_nodes = 28,
	.nodes = { &qhm_snoc_cfg, &qhs_aop,
		   &qhs_aoss, &qhs_apss,
		   &qhs_audio, &qhs_blsp1,
		   &qhs_clk_ctl, &qhs_crypto0_cfg,
		   &qhs_ddrss_cfg, &qhs_ecc_cfg,
		   &qhs_emac_cfg, &qhs_imem_cfg,
		   &qhs_ipa, &qhs_mss_cfg,
...
MODULE_DESCRIPTION("Sdx55 NoC driver");
