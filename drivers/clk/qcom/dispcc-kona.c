...
static void disp_cc_kona_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &disp_cc_kona_desc);
}

static const struct dev_pm_ops disp_cc_kona_pm_ops = {
...
static struct platform_driver disp_cc_kona_driver = {
	...
	.driver = {
		...
		.pm = &disp_cc_kona_pm_ops,
		.sync_state = disp_cc_kona_sync_state,
	},
};
