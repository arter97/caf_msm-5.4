...
static struct rcg_clk dsa_core_clk_src = {
	.cmd_rcgr_reg = MMSS_DSA_CORE_CMD_RCGR,
	.set_rate = set_rate_hid,
...
static struct branch_clk dsa_core_clk = {
	.cbcr_reg = MMSS_DSA_CORE_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "dsa_core_clk",
		.parent = &dsa_core_clk_src.c,
		.ops = &clk_ops_branch,
		CLK_INIT(dsa_core_clk.c),
	},
};

static struct branch_clk dsa_noc_cfg_ahb_clk = {
	.cbcr_reg = MMSS_DSA_NOC_CFG_AHB_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "dsa_noc_cfg_ahb_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(dsa_noc_cfg_ahb_clk.c),
	},
};
...
static struct branch_clk throttle_camss_ahb_clk = {
	.cbcr_reg = MMSS_THROTTLE_CAMSS_AHB_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_camss_ahb_clk",
		.parent = &ahb_clk_src.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_camss_ahb_clk.c),
	},
};

static struct branch_clk throttle_camss_axi_clk = {
	.cbcr_reg = MMSS_THROTTLE_CAMSS_AXI_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_camss_axi_clk",
		.parent = &axi_clk_src.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_camss_axi_clk.c),
	},
};

static struct branch_clk throttle_camss_cxo_clk = {
	.cbcr_reg = MMSS_THROTTLE_CAMSS_CXO_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_camss_cxo_clk",
		.parent = &mmsscc_xo.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_camss_cxo_clk.c),
	},
};

static struct branch_clk throttle_mdss_ahb_clk = {
	.cbcr_reg = MMSS_THROTTLE_MDSS_AHB_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_mdss_ahb_clk",
		.parent = &ahb_clk_src.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_mdss_ahb_clk.c),
	},
};

static struct branch_clk throttle_mdss_axi_clk = {
	.cbcr_reg = MMSS_THROTTLE_MDSS_AXI_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_mdss_axi_clk",
		.parent = &axi_clk_src.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_mdss_axi_clk.c),
	},
};

static struct branch_clk throttle_mdss_cxo_clk = {
	.cbcr_reg = MMSS_THROTTLE_MDSS_CXO_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_mdss_cxo_clk",
		.parent = &mmsscc_xo.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_mdss_cxo_clk.c),
	},
};

static struct branch_clk throttle_video_ahb_clk = {
	.cbcr_reg = MMSS_THROTTLE_VIDEO_AHB_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_video_ahb_clk",
		.parent = &ahb_clk_src.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_video_ahb_clk.c),
	},
};

static struct branch_clk throttle_video_axi_clk = {
	.cbcr_reg = MMSS_THROTTLE_VIDEO_AXI_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_video_axi_clk",
		.parent = &axi_clk_src.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_video_axi_clk.c),
	},
};

static struct branch_clk throttle_video_cxo_clk = {
	.cbcr_reg = MMSS_THROTTLE_VIDEO_CXO_CBCR,
	.has_sibling = 1,
	.base = &virt_base,
	.c = {
		.dbg_name = "throttle_video_cxo_clk",
		.parent = &mmsscc_xo.c,
		.ops = &clk_ops_branch,
		CLK_INIT(throttle_video_cxo_clk.c),
	},
};
...
static struct branch_clk hlos1_vote_gpu_smmu_clk = {
	.cbcr_reg = MMSS_HLOS1_VOTE_GPU_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos1_vote_gpu_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos1_vote_gpu_smmu_clk.c),
	},
};

static struct branch_clk hlos1_vote_rot_smmu_clk = {
	.cbcr_reg = MMSS_HLOS1_VOTE_ROT_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos1_vote_rot_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos1_vote_rot_smmu_clk.c),
	},
};

static struct branch_clk hlos1_vote_mdp_smmu_clk = {
	.cbcr_reg = MMSS_HLOS1_VOTE_MDP_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos1_vote_mdp_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos1_vote_mdp_smmu_clk.c),
	},
};

static struct branch_clk hlos1_vote_video_smmu_clk = {
	.cbcr_reg = MMSS_HLOS1_VOTE_VIDEO_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos1_vote_video_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos1_vote_video_smmu_clk.c),
	},
};

static struct branch_clk hlos1_vote_cpp_smmu_clk = {
	.cbcr_reg = MMSS_HLOS1_VOTE_CPP_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos1_vote_cpp_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos1_vote_cpp_smmu_clk.c),
	},
};

static struct branch_clk hlos1_vote_jpeg_smmu_clk = {
	.cbcr_reg = MMSS_HLOS1_VOTE_JPEG_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos1_vote_jpeg_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos1_vote_jpeg_smmu_clk.c),
	},
};

static struct branch_clk hlos1_vote_vfe_smmu_clk = {
	.cbcr_reg = MMSS_HLOS1_VOTE_VFE_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos1_vote_vfe_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos1_vote_vfe_smmu_clk.c),
	},
};

static struct branch_clk hlos2_vote_gpu_smmu_clk = {
	.cbcr_reg = MMSS_HLOS2_VOTE_GPU_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos2_vote_gpu_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos2_vote_gpu_smmu_clk.c),
	},
};

static struct branch_clk hlos2_vote_rot_smmu_clk = {
	.cbcr_reg = MMSS_HLOS2_VOTE_ROT_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos2_vote_rot_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos2_vote_rot_smmu_clk.c),
	},
};

static struct branch_clk hlos2_vote_mdp_smmu_clk = {
	.cbcr_reg = MMSS_HLOS2_VOTE_MDP_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos2_vote_mdp_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos2_vote_mdp_smmu_clk.c),
	},
};

static struct branch_clk hlos2_vote_video_smmu_clk = {
	.cbcr_reg = MMSS_HLOS2_VOTE_VIDEO_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos2_vote_video_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos2_vote_video_smmu_clk.c),
	},
};

static struct branch_clk hlos2_vote_cpp_smmu_clk = {
	.cbcr_reg = MMSS_HLOS2_VOTE_CPP_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos2_vote_cpp_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos2_vote_cpp_smmu_clk.c),
	},
};

static struct branch_clk hlos2_vote_jpeg_smmu_clk = {
	.cbcr_reg = MMSS_HLOS2_VOTE_JPEG_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos2_vote_jpeg_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos2_vote_jpeg_smmu_clk.c),
	},
};

static struct branch_clk hlos2_vote_vfe_smmu_clk = {
	.cbcr_reg = MMSS_HLOS2_VOTE_VFE_SMMU_CBCR,
	.has_sibling = 0,
	.base = &virt_base,
	.c = {
		.dbg_name = "hlos2_vote_vfe_smmu_clk",
		.ops = &clk_ops_branch,
		CLK_INIT(hlos2_vote_vfe_smmu_clk.c),
	},
};
...
static struct mux_clk mmss_gcc_dbg_clk = {
	...
	MUX_SRC_LIST(
		...
		{ &throttle_camss_ahb_clk.c, 0x00a4 },
		{ &throttle_mdss_ahb_clk.c, 0x00a5 },
		{ &throttle_video_ahb_clk.c, 0x00a6 },
		{ &throttle_camss_cxo_clk.c, 0x00a7 },
		{ &throttle_mdss_cxo_clk.c, 0x00a8 },
		{ &throttle_video_cxo_clk.c, 0x00a9 },
		{ &throttle_camss_axi_clk.c, 0x00aa },
...
static struct clk_lookup msm_clocks_mmss_thulium[] = {
	...
	CLK_LIST(dsa_core_clk),
	CLK_LIST(dsa_noc_cfg_ahb_clk),
	CLK_LIST(fd_ahb_clk),
	...
	CLK_LIST(throttle_camss_ahb_clk),
	CLK_LIST(throttle_camss_axi_clk),
	CLK_LIST(throttle_camss_cxo_clk),
	CLK_LIST(throttle_mdss_ahb_clk),
	CLK_LIST(throttle_mdss_axi_clk),
	CLK_LIST(throttle_mdss_cxo_clk),
	CLK_LIST(throttle_video_ahb_clk),
	CLK_LIST(throttle_video_axi_clk),
	CLK_LIST(throttle_video_cxo_clk),
	...
	CLK_LIST(hlos1_vote_gpu_smmu_clk),
	CLK_LIST(hlos1_vote_rot_smmu_clk),
	CLK_LIST(hlos1_vote_mdp_smmu_clk),
	CLK_LIST(hlos1_vote_video_smmu_clk),
	CLK_LIST(hlos1_vote_cpp_smmu_clk),
	CLK_LIST(hlos1_vote_jpeg_smmu_clk),
	CLK_LIST(hlos1_vote_vfe_smmu_clk),
	CLK_LIST(hlos2_vote_gpu_smmu_clk),
	CLK_LIST(hlos2_vote_rot_smmu_clk),
	CLK_LIST(hlos2_vote_mdp_smmu_clk),
	CLK_LIST(hlos2_vote_video_smmu_clk),
	CLK_LIST(hlos2_vote_cpp_smmu_clk),
	CLK_LIST(hlos2_vote_jpeg_smmu_clk),
	CLK_LIST(hlos2_vote_vfe_smmu_clk),
...
static struct of_device_id msm_clock_mmss_match_table[] = {
	{ .compatible = "qcom,mmsscc-thulium" },
	{}
};

static struct platform_driver msm_clock_mmss_driver = {
	.probe = msm_mmsscc_thulium_probe,
	.driver = {
		.name = "qcom,mmsscc-thulium",
