...
#define DRIVER_NAME	"ipc_msm_otg"
...
static unsigned int lpm_disconnect_thresh = 1000;
...
static int msm_otg_pm_notify(struct notifier_block *notify_block,
...
static const struct file_operations msm_otg_state_fops = {
...
static const struct file_operations msm_otg_chg_fops = {
...
static const struct file_operations msm_otg_aca_fops = {
...
static const struct file_operations msm_otg_dbg_buff_fops = {
...
static const struct file_operations msm_otg_bus_fops = {
...
static struct msm_otg_platform_data *msm_otg_dt_to_pdata(
		struct platform_device *pdev)
{
...
free_motg:
 ...
 /*
  * msm_otg_mode: USB VBUS-IN Signal Notify
  * @usbdev    :  USB Device Type Host(0) / Device(1)
  */

void phy_msm_otg_mode(int mode_type)
{
	struct msm_otg  *motg = the_msm_otg;
	struct usb_phy *phy = &motg->phy;
...
EXPORT_SYMBOL(phy_msm_otg_mode);

void pyh_msm_id_status(int mode_type)
{
	struct msm_otg  *motg = the_msm_otg;
...
EXPORT_SYMBOL(pyh_msm_id_status);
...
MODULE_DESCRIPTION("IPC USB transceiver driver");
