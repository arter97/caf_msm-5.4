...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE_INTERFACE_NUMBER(QUALCOMM_VENDOR_ID, 0x9025, 0)},   /* Qualcomm MDM Diag Port*/
	{ USB_DEVICE_INTERFACE_NUMBER(QUALCOMM_VENDOR_ID, 0x9025, 2)},   /* Qualcomm MDM Legacy Modem Port*/
