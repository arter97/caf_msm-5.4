...
static const struct pinctrl_pin_desc sa515m_pins[] = {
...
static const struct msm_function sa515m_functions[] = {
	FUNCTION(gpio),
	FUNCTION(uim2_data),
	FUNCTION(qdss_stm31),
	FUNCTION(blsp_uart1),
 ...
 */
static const struct msm_pingroup sa515m_groups[] = {
...
static const struct msm_pinctrl_soc_data sa515m_pinctrl = {
	...
	.functions = sa515m_functions,
	.nfunctions = ARRAY_SIZE(sa515m_functions),
...
{
	return msm_pinctrl_probe(pdev, &sa515m_pinctrl);
}

static const struct of_device_id sa515m_pinctrl_of_match[] = {
	{ .compatible = "qcom,sa515m-pinctrl", },
	{ },
};

static struct platform_driver sa515m_pinctrl_driver = {
	.driver = {
		.name = "sa515m-pinctrl",
		.of_match_table = sa515m_pinctrl_of_match,
	},
	.probe = sa515m_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init sa515m_pinctrl_init(void)
{
	return platform_driver_register(&sa515m_pinctrl_driver);
}
arch_initcall(sa515m_pinctrl_init);

static void __exit sa515m_pinctrl_exit(void)
{
	platform_driver_unregister(&sa515m_pinctrl_driver);
}
module_exit(sa515m_pinctrl_exit);

MODULE_DESCRIPTION("QTI sa515m pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, sa515m_pinctrl_of_match);
