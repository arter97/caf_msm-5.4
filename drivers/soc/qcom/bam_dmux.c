...
EXPORT_SYMBOL(msm_bam_dmux_write);
...
EXPORT_SYMBOL(msm_bam_dmux_open);
...
EXPORT_SYMBOL(msm_bam_dmux_close);
...
EXPORT_SYMBOL(msm_bam_dmux_is_ch_full);
...
EXPORT_SYMBOL(msm_bam_dmux_is_ch_low);
...
EXPORT_SYMBOL(msm_bam_dmux_ul_power_vote);
...
EXPORT_SYMBOL(msm_bam_dmux_ul_power_unvote);
...
static void ul_wakeup(void)
{
	 ...
	 * chances are it already came in and this will just fallthrough
	 * instead of waiting
	 */
	if (wait_for_ack) {
