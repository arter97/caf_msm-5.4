...
#define IPA_PROC_TX_CMDQ_CFG 0x0000305C
#define IPA_PROC_TX_CMDQ_CFG_BLOCK_WR_BMSK 0x2
#define IPA_PROC_TX_CMDQ_CFG_BLOCK_WR_SHFT 1

#define IPA_PROC_TX_CMDQ_STATUS 0x00003070
#define IPA_PROC_TX_CMDQ_STATUS_CMDQ_EMPTY_BMSK 0x2
#define IPA_PROC_TX_CMDQ_STATUS_CMDQ_EMPTY_SHFT 1

#define IPA_STATE 0x0000052C
#define IPA_STATE_TX_IDLE_BMSK 0x20
#define IPA_STATE_TX_IDLE_SHFT 5

#define IPA_STEP_MODE_BREAKPOINTS 0x00003074
#define IPA_STEP_MODE_BREAKPOINTS_TX_START 0x10000

#define IPA_DEBUG_DATA_SEL 0x00003028
#define IPA_DEBUG_DATA_SEL_PIPE_SELECT_BMSK 0x5
#define IPA_DEBUG_DATA_SEL_PIPE_SELECT_SHFT 16
#define IPA_DEBUG_DATA_SEL_INTERNAL_BLOCK_SELECT_BMSK 0x8
#define IPA_DEBUG_DATA_SEL_INTERNAL_BLOCK_SELECT_SHFT 8
#define IPA_DEBUG_DATA_SEL_EXTERNAL_BLOCK_SELECT_BMSK 0x8
#define IPA_DEBUG_DATA_SEL_EXTERNAL_BLOCK_SELECT_SHFT 0

#define IPA_DEBUG_DATA 0x0000302C

#define IPA_DEBUG_CTRL_FSM_STATE1_BMSK (0x6000000)
