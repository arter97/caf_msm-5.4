				...
				struct qca199x_dev *qca199x_dev)
{
	...
	usleep_range(10000, 10100);  /* 10ms wait */
	...
	usleep_range(100, 105); /* 100uS wait */
	...
	usleep_range(20000, 20050);  /* 20ms wait */
	/* LS_EN = 1 */
	 ...
	 */
	usleep_range(15000, 15050); /* 15 ms */
	...
	do {
		...
		if (((rsp[0] == CORE_RESET_RSP_GID) &&
		  ...
		  usleep_range(2000, 2010);  /* 2ms sleep before retry */
		}
		time_taken++;
