...
#define DRV_NAME "apq8084-asoc-taiko"
...
{
	struct snd_soc_card *card = &snd_soc_card_apq8084;
	...
	if (of_property_read_bool(pdev->dev.of_node, "qcom,hdmi-audio-rx")) {
		...
		memcpy(apq8084_dai_links, apq8084_common_dai_links,
			sizeof(apq8084_common_dai_links));

		memcpy(apq8084_dai_links + ARRAY_SIZE(apq8084_common_dai_links),
			apq8084_hdmi_dai_link, sizeof(apq8084_hdmi_dai_link));
		...
		card->dai_link	= apq8084_common_dai_links;
