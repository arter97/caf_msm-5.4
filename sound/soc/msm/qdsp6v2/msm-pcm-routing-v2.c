...
static void msm_pcm_routing_process_voice(u16 reg, u16 val, int set)
{
	...
	else if (val == MSM_FRONTEND_DAI_VOIP2)
...
static const struct snd_kcontrol_new pri_rx_voice_mixer_controls[] = {
	...
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_PRI_I2S_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new sec_i2s_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_SEC_I2S_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new sec_mi2s_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_SECONDARY_MI2S_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new slimbus_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_SLIMBUS_0_RX ,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new bt_sco_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_INT_BT_SCO_RX ,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new mi2s_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_MI2S_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new afe_pcm_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_AFE_PCM_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new aux_pcm_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_AUXPCM_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new sec_aux_pcm_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_SEC_AUXPCM_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new hdmi_rx_voice_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_VOIP, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("Voip2", MSM_BACKEND_DAI_HDMI_RX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
...
static const struct snd_kcontrol_new tx_voip2_mixer_controls[] = {
	SOC_SINGLE_EXT("PRI_TX_Voip2", MSM_BACKEND_DAI_PRI_I2S_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("MI2S_TX_Voip2", MSM_BACKEND_DAI_MI2S_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("SLIM_0_TX_Voip2", MSM_BACKEND_DAI_SLIMBUS_0_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("INTERNAL_BT_SCO_TX_Voip2",
	MSM_BACKEND_DAI_INT_BT_SCO_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("AFE_PCM_TX_Voip2", MSM_BACKEND_DAI_AFE_PCM_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("AUX_PCM_TX_Voip2", MSM_BACKEND_DAI_AUXPCM_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("SEC_AUX_PCM_TX_Voip2", MSM_BACKEND_DAI_SEC_AUXPCM_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
	SOC_SINGLE_EXT("PRI_MI2S_TX_Voip2", MSM_BACKEND_DAI_PRI_MI2S_TX,
	MSM_FRONTEND_DAI_VOIP2, 1, 0, msm_routing_get_voice_mixer,
	msm_routing_put_voice_mixer),
};
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	SND_SOC_DAPM_AIF_IN("VOIP2_DL", "VoIP2 Playback", 0, 0, 0, 0),
	...
	SND_SOC_DAPM_AIF_OUT("VOIP2_UL", "VoIP2 Capture", 0, 0, 0, 0),
	...
	*/
	...
	SND_SOC_DAPM_MIXER("Voip2_Tx Mixer",
			   SND_SOC_NOPM, 0, 0, tx_voip2_mixer_controls,
			   ARRAY_SIZE(tx_voip2_mixer_controls)),
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"MI2S_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"PRI_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"SEC_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"SEC_MI2S_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"SLIM_0_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"INTERNAL_BT_SCO_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"AFE_PCM_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"AUX_PCM_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"SEC_AUX_PCM_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"HDMI_RX_Voice Mixer", "Voip2", "VOIP2_DL"},
	...
	{"Voip2_Tx Mixer", "PRI_TX_Voip2", "PRI_I2S_TX"},
	{"Voip2_Tx Mixer", "MI2S_TX_Voip2", "MI2S_TX"},
	{"Voip2_Tx Mixer", "SLIM_0_TX_Voip2", "SLIMBUS_0_TX"},
	{"Voip2_Tx Mixer", "INTERNAL_BT_SCO_TX_Voip2", "INT_BT_SCO_TX"},
	{"Voip2_Tx Mixer", "AFE_PCM_TX_Voip2", "PCM_TX"},
	{"Voip2_Tx Mixer", "AUX_PCM_TX_Voip2", "AUX_PCM_TX"},
	{"Voip2_Tx Mixer", "SEC_AUX_PCM_TX_Voip2", "SEC_AUX_PCM_TX"},
	{"Voip2_Tx Mixer", "PRI_MI2S_TX_Voip2", "PRI_MI2S_TX"},
	{"VOIP2_UL", NULL, "Voip2_Tx Mixer"},
