...
static int msm_dai_q6_dev_probe(struct platform_device *pdev)
{
	...
	case SLIMBUS_6_RX:
		...
		goto register_slim_playback;
	case SLIMBUS_7_RX:
		strlcpy(stream_name, "Slimbus7 Playback", 80);
		goto register_slim_playback;
	case SLIMBUS_8_RX:
		strlcpy(stream_name, "Slimbus8 Playback", 80);
		goto register_slim_playback;
register_slim_playback:
	...
	case SLIMBUS_6_TX:
		...
		goto register_slim_capture;
	case SLIMBUS_7_TX:
		strlcpy(stream_name, "Slimbus7 Capture", 80);
		goto register_slim_capture;
	case SLIMBUS_8_TX:
		strlcpy(stream_name, "Slimbus8 Capture", 80);
		goto register_slim_capture;
